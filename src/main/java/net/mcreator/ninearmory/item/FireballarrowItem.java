...
public class FireballarrowItem extends NineArmoryModElements.ModElement {
	@ObjectHolder("nine_armory:fireballarrow")
	public static final Item block = null;
	@ObjectHolder("nine_armory:entitybulletfireballarrow")
	public static final EntityType arrow = null;
	public FireballarrowItem(NineArmoryModElements instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletfireballarrow").setRegistryName("entitybulletfireballarrow"));
	}
